...
// ==================== TYPES ====================
interface UserRole { role: string; name: string; department: string; areas: string[]; spreadsheetId?: string; }
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div className="p-5 border-b border-gray-100 flex items-center justify-between flex-wrap gap-3">
                ...
                <div className="flex items-center gap-2 flex-wrap">
                    ...
                    {userRole?.role === 'ADMIN' && userRole.spreadsheetId && (
                        <a
                            href={`https://docs.google.com/spreadsheets/d/${userRole.spreadsheetId}/export?format=xlsx`}
                            target="_blank"
                            className="btn-press text-sm bg-emerald-50 text-emerald-600 px-4 py-2 rounded-lg font-semibold hover:bg-emerald-100 transition-colors flex items-center gap-1.5"
                        >
                            📊 Xuất Excel
                        </a>
                    )}
